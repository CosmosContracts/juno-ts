export declare const createRPCQueryClient: ({ rpcEndpoint }: {
    ...
    juno: {
        mint: {
            params(request?: import("./mint/query").QueryParamsRequest): Promise<import("./mint/query").QueryParamsResponseSDKType>;
            inflation(request?: import("./mint/query").QueryInflationRequest): Promise<import("./mint/query").QueryInflationResponseSDKType>;
            annualProvisions(request?: import("./mint/query").QueryAnnualProvisionsRequest): Promise<import("./mint/query").QueryAnnualProvisionsResponseSDKType>;
        };
    };
}>;
