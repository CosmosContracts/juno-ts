...
export function useJunoSwapToken2ForToken1PriceQuery({
  ...
  args,
  options
}: JunoSwapToken2ForToken1PriceQuery) {
  return useQuery<Token2ForToken1PriceResponse, Error, Token2ForToken1PriceResponse, (string | undefined)[]>(["junoSwapToken2ForToken1Price", client?.contractAddress, JSON.stringify(args)], () => client ? client.token2ForToken1Price({
...
export function useJunoSwapToken1ForToken2PriceQuery({
  ...
  args,
  options
}: JunoSwapToken1ForToken2PriceQuery) {
  return useQuery<Token1ForToken2PriceResponse, Error, Token1ForToken2PriceResponse, (string | undefined)[]>(["junoSwapToken1ForToken2Price", client?.contractAddress, JSON.stringify(args)], () => client ? client.token1ForToken2Price({
...
export function useJunoSwapInfoQuery({
  ...
  return useQuery<InfoResponse, Error, InfoResponse, (string | undefined)[]>(["junoSwapInfo", client?.contractAddress], () => client ? client.info() : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
...
export function useJunoSwapBalanceQuery({
  ...
  args,
  options
}: JunoSwapBalanceQuery) {
  return useQuery<BalanceResponse, Error, BalanceResponse, (string | undefined)[]>(["junoSwapBalance", client?.contractAddress, JSON.stringify(args)], () => client ? client.balance({
