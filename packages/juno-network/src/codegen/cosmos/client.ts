...
import * as cosmosTokenfactoryV1beta1TxRegistry from "./tokenfactory/v1beta1/tx.registry";
...
import * as cosmosTokenfactoryV1beta1TxAmino from "./tokenfactory/v1beta1/tx.amino";
import * as cosmosUpgradeV1beta1TxAmino from "./upgrade/v1beta1/tx.amino";
export const cosmosAminoConverters = { ...cosmosBankV1beta1TxAmino.AminoConverter,
  ...
  ...cosmosTokenfactoryV1beta1TxAmino.AminoConverter,
  ...cosmosUpgradeV1beta1TxAmino.AminoConverter
};
export const cosmosProtoRegistry: ReadonlyArray<[string, GeneratedType]> = [...cosmosBankV1beta1TxRegistry.registry, ...cosmosDistributionV1beta1TxRegistry.registry, ...cosmosGovV1TxRegistry.registry, ...cosmosGovV1beta1TxRegistry.registry, ...cosmosStakingV1beta1TxRegistry.registry, ...cosmosTokenfactoryV1beta1TxRegistry.registry, ...cosmosUpgradeV1beta1TxRegistry.registry];
