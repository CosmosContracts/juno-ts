...
export class MsgClientImpl implements Msg {
  ...
  createDenom(request: MsgCreateDenom): Promise<MsgCreateDenomResponse> {
    ...
    const promise = this.rpc.request("cosmos.tokenfactory.v1beta1.Msg", "CreateDenom", data);
    return promise.then(data => MsgCreateDenomResponse.decode(new _m0.Reader(data)));
  }

  mint(request: MsgMint): Promise<MsgMintResponse> {
    const data = MsgMint.encode(request).finish();
    const promise = this.rpc.request("cosmos.tokenfactory.v1beta1.Msg", "Mint", data);
    return promise.then(data => MsgMintResponse.decode(new _m0.Reader(data)));
  }

  burn(request: MsgBurn): Promise<MsgBurnResponse> {
    const data = MsgBurn.encode(request).finish();
    const promise = this.rpc.request("cosmos.tokenfactory.v1beta1.Msg", "Burn", data);
    return promise.then(data => MsgBurnResponse.decode(new _m0.Reader(data)));
  }

  changeAdmin(request: MsgChangeAdmin): Promise<MsgChangeAdminResponse> {
    const data = MsgChangeAdmin.encode(request).finish();
    const promise = this.rpc.request("cosmos.tokenfactory.v1beta1.Msg", "ChangeAdmin", data);
  ...
  setDenomMetadata(request: MsgSetDenomMetadata): Promise<MsgSetDenomMetadataResponse> {
    ...
    const promise = this.rpc.request("cosmos.tokenfactory.v1beta1.Msg", "SetDenomMetadata", data);
  ...
  forceTransfer(request: MsgForceTransfer): Promise<MsgForceTransferResponse> {
    ...
    const promise = this.rpc.request("cosmos.tokenfactory.v1beta1.Msg", "ForceTransfer", data);
