...
export const AminoConverter = {
  "/ibc.applications.fee.v1.MsgRegisterPayee": {
    ...
    toAmino: ({
      ...
      relayer,
      payee
    }: MsgRegisterPayee): AminoMsgRegisterPayee["value"] => {
      return {
        port_id: portId,
    ...
    fromAmino: ({
      ...
      relayer,
      payee
    }: AminoMsgRegisterPayee["value"]): MsgRegisterPayee => {
      return {
        portId: port_id,
  ...
  "/ibc.applications.fee.v1.MsgRegisterCounterpartyPayee": {
    ...
    toAmino: ({
      ...
      relayer,
      counterpartyPayee
    }: MsgRegisterCounterpartyPayee): AminoMsgRegisterCounterpartyPayee["value"] => {
      return {
        port_id: portId,
        channel_id: channelId,
        relayer,
    ...
    fromAmino: ({
      ...
      relayer,
      counterparty_payee
    }: AminoMsgRegisterCounterpartyPayee["value"]): MsgRegisterCounterpartyPayee => {
      return {
        portId: port_id,
        channelId: channel_id,
        relayer,
